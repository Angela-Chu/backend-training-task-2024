...
const classPrice = 150;
let machineTime = 3;
let classTaken = 2;
let machineUsePriceTotal = machineUsePrice * machineTime;
let groupClassesTotal = classPrice * classTaken;
...
a = 13; // 將 a 變數賦值為 13
a = b + 4; // 將 a 變數賦值為 (b 變數 + 4)
a - b; // 將 a 變數減掉 b 變數
b += 1; // 將 b 變數賦值為 (b 變數 + 1)
// 答案為： a = 4 、 b = 1
...
let numberArr1 = [5, 10, 15]; // 宣告一個陣列numberArr1
let numberArr2 = numberArr1; // 宣告另一個陣列numberArr2(但指向同一個記憶體)
numberArr2.push(20); //陣列numberArr2變為[5,10,15,20](numberArr1也同時變成[5,10,15,20])
numberArr2 = [25, 30, 35]; //將陣列numberArr2重新指向新的記憶體，變為[25, 30, 35]，不再與陣列numberArr1共用
console.log(numberArr1, numberArr2); //印出陣列numberArr1、陣列numberArr2
