...
var l = '8';
// 請文字解釋為什麼
console.log(k * l > 21); // true。因為變數l會轉型為number，3 * 8 = 24，24 > 21
...
*/
const activities = {
  running : {calorieByMinute: 10},
  yoga : {calorieByMinute: 5},
  biking : {calorieByMinute: 8},
...
// 練習：計算小明今日消耗的卡路里
calorieBurn = (activities.calorie[0].calorieByMinute * timeRun) + (activities.calorie[1].calorieByMinute * timeYoga) + (activities.calorie[2].calorieByMinute * timeBike); 
